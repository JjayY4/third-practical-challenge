...
<head>
    ...
    <style>
        ...
        .form-control, .form-select {
            ...
            color: #f1f1f1; border-radius: 8px;
        }
        ...
        <div class="col-md-4">
            <div class="card p-4">
                <div class="text-center mb-4">
                    ...
                    <p class="text-secondary small mt-1">Sign in to your account</p>
                </div>
                ...
                <p class="text-center text-secondary small mt-4 mb-0">
                    Don't have an account? <a href="index.php?controller=auth&action=register">Register</a>
                </p>
            </div>
        </div>
    </div>
